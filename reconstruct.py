...
def main(args):
    ...
    project_dir = os.path.abspath(os.path.dirname(__file__))
    init_samples = torch.load(f'{project_dir}/random_init_samples.pth', map_location='cpu')  # 4000
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_iters', default=200, type=int, help='number of iteration per reconstruction')
    ...
    parser.add_argument('--encoder_list', default=[ 'VGGNet19', 'SwinTransformer'], type=list,
    ...
    args.save_dir = f'results/{args.dataset}/{args.enc_tgt}_black1'

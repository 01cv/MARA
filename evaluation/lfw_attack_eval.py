...
def main(args):
    ...
    sub_mask = np.array([False] * 3000, dtype=bool)
    ...
    for i in range(10):
        ...
        best_threshold = get_best_threshold(pos_train, neg_train)  #通过pos_score 和 neg_score 构建出最佳阈值
...
if __name__ == "__main__":
    ...
    parser.add_argument('--attack_img_dir', type=str,
                        default='/media/ahu/Storage1/Black-box-Face-Reconstruction-main1/results/lfw/AdaFace_4k/attack_images')
    ...
    args.img_dir = f'/media/ahu/Storage1/Black-box-Face-Reconstruction-main1/data/lfw/{args.align}_aligned'  # directory for lfw images
    args.txt_dir = '/media/ahu/Storage1/Black-box-Face-Reconstruction-main1/data/lfw/pairs.txt'  # directory for lfw pairs.txt
    main(args)

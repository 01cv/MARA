...
if __name__ == "__main__":
    ...
    parser.add_argument('--attack_img_dir', type=str,
                        default='/media/ahu/Storage1/Black-box-Face-Reconstruction-main1/results/cfp-fp-F/SwinTransformer_4k/attack_images')
    ...
    args.txt_dir = '/media/ahu/Storage1/Black-box-Face-Reconstruction-main1/data/cfp/Protocol'  # directory for cfp Pair_list txt
    main(args)